...
pub enum sockaddr { }
extern "C" {
    pub static mut RTMPProtocolStringsLower: [[::std::os::raw::c_char; 7usize]; 0usize];
...
extern "C" {
    ...
    pub fn AMF_EncodeNamedBoolean(output: *mut ::std::os::raw::c_char,
                                  ...
                                  bVal: ::std::os::raw::c_int)
                                  -> *mut ::std::os::raw::c_char;
    pub fn AMF_DecodeInt16(data: *const ::std::os::raw::c_char) -> ::std::os::raw::c_ushort;
    pub fn AMF_DecodeInt24(data: *const ::std::os::raw::c_char) -> ::std::os::raw::c_uint;
    pub fn AMF_DecodeInt32(data: *const ::std::os::raw::c_char) -> ::std::os::raw::c_uint;
    pub fn AMF_DecodeString(data: *const ::std::os::raw::c_char, str: *mut AVal);
    pub fn AMF_DecodeLongString(data: *const ::std::os::raw::c_char, str: *mut AVal);
    pub fn AMF_DecodeBoolean(data: *const ::std::os::raw::c_char) -> ::std::os::raw::c_int;
    ...
    pub fn AMF_GetProp(obj: *mut AMFObject,
                       name: *const AVal,
    ...
    pub fn AMFProp_SetBoolean(prop: *mut AMFObjectProperty, bflag: ::std::os::raw::c_int);
    pub fn AMFProp_SetString(prop: *mut AMFObjectProperty, str: *mut AVal);
    pub fn AMFProp_SetObject(prop: *mut AMFObjectProperty, obj: *mut AMFObject);
    ...
    pub fn AMFProp_GetBoolean(prop: *mut AMFObjectProperty) -> ::std::os::raw::c_int;
    pub fn AMFProp_GetString(prop: *mut AMFObjectProperty, str: *mut AVal);
    pub fn AMFProp_GetObject(prop: *mut AMFObjectProperty, obj: *mut AMFObject);
    pub fn AMFProp_IsValid(prop: *mut AMFObjectProperty) -> ::std::os::raw::c_int;
    ...
    pub fn RTMP_SetOpt(r: *mut RTMP, opt: *const AVal, arg: *mut AVal) -> ::std::os::raw::c_int;
    pub fn RTMP_SetupURL(r: *mut RTMP, url: *mut ::std::os::raw::c_char) -> ::std::os::raw::c_int;
    ...
    pub fn RTMP_Connect(r: *mut RTMP, cp: *mut RTMPPacket) -> ::std::os::raw::c_int;
    pub fn RTMP_Connect0(r: *mut RTMP, svc: *mut sockaddr) -> ::std::os::raw::c_int;
    pub fn RTMP_Connect1(r: *mut RTMP, cp: *mut RTMPPacket) -> ::std::os::raw::c_int;
    pub fn RTMP_Serve(r: *mut RTMP) -> ::std::os::raw::c_int;
    pub fn RTMP_TLS_Accept(r: *mut RTMP,
                           ctx: *mut ::std::os::raw::c_void)
                           -> ::std::os::raw::c_int;
    pub fn RTMP_ReadPacket(r: *mut RTMP, packet: *mut RTMPPacket) -> ::std::os::raw::c_int;
    pub fn RTMP_SendPacket(r: *mut RTMP,
                           packet: *mut RTMPPacket,
                           queue: ::std::os::raw::c_int)
                           -> ::std::os::raw::c_int;
    pub fn RTMP_SendChunk(r: *mut RTMP, chunk: *mut RTMPChunk) -> ::std::os::raw::c_int;
    ...
    pub fn RTMP_ConnectStream(r: *mut RTMP,
                              seekTime: ::std::os::raw::c_int)
                              -> ::std::os::raw::c_int;
    pub fn RTMP_ReconnectStream(r: *mut RTMP,
                                seekTime: ::std::os::raw::c_int)
                                -> ::std::os::raw::c_int;
    pub fn RTMP_DeleteStream(r: *mut RTMP);
    pub fn RTMP_GetNextMediaPacket(r: *mut RTMP, packet: *mut RTMPPacket) -> ::std::os::raw::c_int;
    pub fn RTMP_ClientPacket(r: *mut RTMP, packet: *mut RTMPPacket) -> ::std::os::raw::c_int;
    ...
    pub fn RTMP_SendCtrl(r: *mut RTMP,
                         nType: ::std::os::raw::c_short,
                         nObject: ::std::os::raw::c_uint,
                         nTime: ::std::os::raw::c_uint)
                         -> ::std::os::raw::c_int;
    pub fn RTMP_SendPause(r: *mut RTMP,
                          DoPause: ::std::os::raw::c_int,
                          dTime: ::std::os::raw::c_int)
                          -> ::std::os::raw::c_int;
    pub fn RTMP_Pause(r: *mut RTMP, DoPause: ::std::os::raw::c_int) -> ::std::os::raw::c_int;
    ...
    pub fn RTMP_SendSeek(r: *mut RTMP, dTime: ::std::os::raw::c_int) -> ::std::os::raw::c_int;
    ...
    pub fn RTMP_HashSWF(url: *const ::std::os::raw::c_char,
                        ...
                        -> ::std::os::raw::c_int;
    pub fn create_server(port: ::std::os::raw::c_int) -> ::std::os::raw::c_int;
}
